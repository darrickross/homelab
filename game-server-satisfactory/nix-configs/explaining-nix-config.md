...
- [`example-secrets.nix`](#example-secretsnix)
- [`satisfactory.nix`](#satisfactorynix)
  - [Variables](#variables)
  - [Service Account](#service-account)
  - [Systemd Service for Satisfactory](#systemd-service-for-satisfactory)
  - [Firewall](#firewall)
  - [Logging](#logging)
- [`system-configs.nix`](#system-configsnix)
